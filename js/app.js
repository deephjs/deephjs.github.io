...
/***/ function(module, exports) {
	...
	;(function () {
	    ...
	    matrix3D.prototype = {
	        ...
	        appendTransform: function appendTransform(perspective, x, y, z, scaleX, scaleY, scaleZ, rotateX, rotateY, rotateZ, regX, regY, regZ) {
	            ...
	            this.multiplyMatrices(this, new matrix3D(cosy, 0, siny, x, 0, 1, 0, y, -siny, 0, cosy, z, siny / perspective, 0, -cosy / perspective, (perspective - z) / perspective));

	            this.multiplyMatrices(this, new matrix3D(1, 0, 0, 0, 0, cosx, sinx, 0, 0, -sinx, cosx, 0, 0, sinx / perspective, -cosx / perspective, 1));

	            this.multiplyMatrices(this, new matrix3D(cosz * scaleX, sinz * scaleY, 0, 0, -sinz * scaleX, cosz * scaleY, 0, 0, 0, 0, 1 * scaleZ, 0, 0, 0, -1 / perspective, 1));
	    ...
	    window.Transform = function (element) {
	        ...
	        observe(element, ["translateX", "translateY", "translateZ", "scaleX", "scaleY", "scaleZ", "perspective", "rotateX", "rotateY", "rotateZ", "regX", "regY", "regZ"], function () {
